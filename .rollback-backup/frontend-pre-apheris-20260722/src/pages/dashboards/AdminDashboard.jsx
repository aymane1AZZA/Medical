...
import { FiActivity, FiDatabase, FiServer, FiUsers } from 'react-icons/fi';
      ...
      {dashboard && (
        <div className="space-y-6">
          <div className="grid gap-4 md:grid-cols-4">
            <StatCard label="Utilisateurs" value="554" icon={FiUsers} />
            <StatCard label="Services" value="18" icon={FiDatabase} tone="text-chu-sky" />
            <StatCard label="Équipements" value="246" icon={FiServer} tone="text-indigo-600" />
            <StatCard label="Alertes" value="7" icon={FiActivity} tone="text-chu-red" />
          </div>
