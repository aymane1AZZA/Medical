...
import { CheckSquare, Droplet, FilePlus, Send } from 'lucide-react';
      ...
      {dashboard && (
        <div className="space-y-6">
          <div className="grid gap-4 md:grid-cols-4">
            <StatCard label="Demandes" value="61" icon={FilePlus} />
            <StatCard label="Prélèvements" value="47" icon={Droplet} tone="text-info" />
            <StatCard label="Validées" value="36" icon={CheckSquare} tone="text-success" />
            <StatCard label="Transmises" value="32" icon={Send} tone="text-primary" />
          </div>
