      ...
      {dashboard && (
        <div className="space-y-6">
          <div className="grid gap-4 md:grid-cols-4">
            <StatCard label="Patients du service" value="24" icon={HeartPulse} />
            <StatCard label="Constantes" value="68" icon={Thermometer} tone="text-destructive" />
            <StatCard label="Soins planifiés" value="31" icon={ClipboardList} tone="text-info" />
            <StatCard label="Observations" value="15" icon={Activity} tone="text-primary" />
          </div>
