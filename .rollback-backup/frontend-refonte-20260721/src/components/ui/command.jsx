...
function CommandDialog({
  ...
  description = "Rechercher une commande ou un dossier.",
  children,
  className,
...
const CommandInput = React.forwardRef(function CommandInput({
  ...
  return (
    <div data-slot="command-input-wrapper" className="p-1 pb-0">
      <InputGroup
        className="!h-8 !rounded-lg border-input/30 bg-input/30 !shadow-none [&_[data-slot=input-group-addon]]:!pl-2">
...
function CommandItem({
  ...
  return (
    <CommandPrimitive.Item
      ...
      className={cn(
        "group/command-item relative flex cursor-default select-none items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-none data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50 data-[selected=true]:bg-muted data-[selected=true]:text-foreground [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}>
      {children}
